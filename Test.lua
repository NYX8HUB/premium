...
local defaultProperties = {
    ...
    SubTextColor = Color3.fromRGB(180, 180, 180) -- Cor do subtítulo
}
...
function Library:newtab(config)
    if not self._parent then
        error("A UI deve ser criada primeiro com Library:create()")
    end
...
-- Métodos para adicionar botões e toggles às abas
